...
const Hero = () => {
  ...
  return (
  <section className=' hero_min_height hero_bg pt-3'>
      ...
      <div className="container max_width_1140">
        <nav className=' d-flex align-items-center justify-content-between'>
          ...
          <ul className={`${data ? "navShow":"navhide"} gap-4 d-flex align-items-center mobile_view ps-0 mb-0`}>
            <li><a href="#home" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>Home</a></li>
            <li><a href="#aboutus" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>About us</a></li>
            <li><a href="#services" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>Services</a></li>
            <li><a href="#pricing" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>Pricing</a></li>
            <li><a href="#blog" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>Blog</a></li>
            <li><a href="#contactus" className='Font_Acumin_Pro navlink color_gray fw-bold font_size_sm line_height_sm nav_links'>Contact us</a></li>
            <li>
   ...
   <div className=" container max_width_1140" id='home'>
    <div className=" d-flex align-items-center flex-column justify-content-center">
    <h1 className=' mb-0 text-white Font_TitlingGothicFBCond font_size_3xl text-center line_height_8xl heading_padding_top max_width_730'>Automotive Dry Ice Cleaning</h1>
    <p className=' mb-0 text-white Font_Acumin_Pro fw-normal text-center font_size_md line_height_2xl pt-3'>Discover the ultimate clean for your machine.</p>
    <p className=' mb-0 text-white Font_Acumin_Pro fw-normal text-center font_size_md line_height_2xl'>No chemicals, no abrasives and no drama.</p>
    ...
    <div className="bg_gray2 rounded-3 py-3 px-3 d-flex align-items-center justify-content-center transparent_div margin_top_40 w-100 z-0">
      <div className=" d-flex align-items-sm-center justify-content-center gap-3 gap_28 flex-wrap">
